    ...
    *,
    ...
    lines.extend(
        [
            ...
            "2. Review `metric_snapshot.json` with emphasis on `final_probe` as the formal acceptance object and `recent_train` as supporting screening evidence.",
            "3. Treat `best_eval`, `last_eval`, and `best.pt` as diagnostic-only when they are present; they are not formal gates.",
            ...
            "2. What do `final_probe` and `recent_train` imply about primary task quality, stability, and training-screen support?",
    ...
    return {
        ...
        "codex_analysis_focus": {
            ...
            "questions": [
                ...
                "Do final_probe and recent_train support improvement, regression, hold, or insufficient evidence, and do any diagnostic-only eval artifacts disagree?",
